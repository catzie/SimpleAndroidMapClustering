...
package net.catzie.mapclustering;
...
import net.catzie.mapclustering.model.MyItem;
...
public class MyItemReader {
    ...
    public List<MyItem> read(InputStream inputStream) throws JSONException {
        ...
        for (int i = 0; i < array.length(); i++) {
            ...
            Log.d("markers ", Double.toString(object.getDouble("lat")) + Double.toString(object.getDouble("lng")));
        }
        return items;
    }
}
